...
function WhyAttend() {
  const reasons = [
    ...
    { title: "Fresh Inspiration", desc: "Reignite your passion for the work. Leave buzzing with new ideas, renewed energy, and a clear vision for where your practice is headed." },
    ...
    { title: "Beautiful Venue", desc: "We find spaces that inspire — expect natural light, great energy, and an atmosphere that matches the quality of the conversations happening inside." },
